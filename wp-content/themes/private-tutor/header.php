...
<div id="header">
	<div class="bottom-header">
		<div class="container">
			<div class="row">
				<div class="logo_img">
					<img src="http://te2019szasz.great-site.net/wp-content/uploads/2021/02/bbte_logo.png" />
				</div>
				...
				<div class="menu-section col-lg-8 col-md-6 col-6">
					...
					<div class="logo_img">
					<img src="http://te2019szasz.great-site.net/wp-content/uploads/2021/02/fsega_logo.png" />
				</div>
